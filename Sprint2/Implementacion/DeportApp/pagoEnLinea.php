...
<body >
	...
	<section class="page-header-section set-bg" data-setbg="img/header.jpg">
		<div class="container">
			<h1 class="header-title">Pago en Linea<span>.</span></h1>
		</div>
	</section>
		...
		<div class="container">
            <form class="form-horizontal" role = "form" method = "post" action="">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <br/>
                        <input class="form-control" type="text" readonly id="Nombre" name="Nombre" placeholder="Nombre de la Reserva"> 
                    </div>
                ...
                <div class = "row">
                    ...
                    <div class="col-xs-11" align="center">
						<input type="submit"  class="btn btn-success" id="submit" name="submit" value="Finalizar">
					</div>
                </div>
